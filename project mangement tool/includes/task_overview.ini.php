            <div id="task_overview" class="body_divisions hidden">
              ...
              <div class="table-responsive">
                ...
                <div class="pull-left">
                  <button id="update_task_button" class="btn btn-primary" data-toggle="modal" data-target="#update_task_modal">
                    <span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>
                    Update Task
                  </button>
                <?php 
                  if (isset($_SESSION['role']) && ($_SESSION['role'] == "Administrator")) {
                    echo '<button class="btn btn-primary" data-toggle="modal" data-target="#edit_task_modal">
